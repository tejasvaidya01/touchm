(function ($, undefined) {
    ...
    function prepareOneSlideBox(slotholder, opt, visible) {
        ...
        if (opt.sloth > opt.slotw)
            ...
            basicsize = opt.slotw; if (!visible) {
            var off = 0 - basicsize;
        }
        opt.slotw = basicsize;
        opt.sloth = basicsize;
    ...
    function removeSlots(container, opt) {
        setTimeout(function () {
        ...
        if (nexttrans == 6) {
            ...
            actsh.find('.slotslide').each(function (i) {
                ...
                if (i < opt.slots / 2)
                    ...
                    var tempo = (2 + opt.slots - i) * 60; if (opt.firefox13) {
                    ss.animate({
                        'top': (0 + (opt.height)) + "px",
                        'opacity': 1
                    }, {
    ...
    function countDown(container, opt) {
        ...
        if (opt.stopAfterLoops != undefined && opt.stopAfterLoops > -1)
            ...
            opt.lastslidetoshow = 999; if (opt.looptogo == 0) opt.stopLoop = "on";
